...
<div class="mb-3">
    ...
    <select class="form-select" id="provider_<?= $prefix ?>" name="provider" onchange="updateProviderConfig('<?= $prefix ?>')"
            data-assist-field="provider"
            data-assist-required="true"
            data-assist-hint="Required. Choose the LLM provider. Claude CLI (recommended) uses Claude Code and supports MCP tools. Ollama runs models locally. Claude API uses Anthropic credits directly."
    ...
    <div id="providerHelp" class="form-text visually-hidden">Select the AI provider for this agent</div>
</div>
            ...
            <div class="card-body">
                ...
                <div class="mb-2">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="<?= $prefix ?>-ollama-direct-host" name="base_url"
                               value="<?= h($providerConfig['base_url'] ?? $providerConfig['host'] ?? 'http://localhost:11434') ?>"
                               placeholder="http://localhost:11434"
                ...
                <div class="mb-2">
                    ...
                    <select class="form-select provider-model-field" id="<?= $prefix ?>-ollama-direct-model" name="model" <?= $provider !== 'ollama' ? 'disabled' : '' ?>>
                        ...
                        <option value="<?= h($providerConfig['model']) ?>" selected>
                            <?= h($providerConfig['model']) ?>
                        </option>
                        <?php else: ?>
                        <option value="">-- Click "Load Models" to fetch --</option>
                        <?php endif; ?>
        ...
        <div class="card bg-light">
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="connections_id" id="<?= $prefix ?>_connections_id">
            ...
            <div class="card-body">
                ...
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control provider-field" name="endpoint"
                           value="<?= h($providerConfig['endpoint'] ?? '') ?>"
