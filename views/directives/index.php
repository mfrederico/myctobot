                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <br><small class="text-muted"><?= htmlspecialchars(substr($directive->parsed_summary, 0, 80)) ?>...</small>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <small><?= htmlspecialchars($directive->email_from) ?></small>
                                    </td>
                                    <td>
                                        <?php
                                        $statusClass = [
                                        ...
                                        <br><small class="text-muted"><?= htmlspecialchars($directive->current_phase) ?></small>
                                        <?php endif; ?>
                                    </td>
                                    <td>
