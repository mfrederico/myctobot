<div class="container py-4" data-assist-page="projects" data-assist-purpose="List CTO projects with status filtering">
    <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <h5 class="card-title mb-0">
                                    <a href="/projects/view/<?= h($project->project_uid) ?>" class="text-decoration-none">
                                        <?= h($project->name) ?>
                                    </a>
                                </h5>
                                <?php
                            ...
                            <p class="card-text text-muted small">
                                <?= h(substr($project->description, 0, 120)) ?>...
                            </p>
                        ...
                        <div class="card-footer bg-transparent border-top-0">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="/projects/view/<?= h($project->project_uid) ?>"
