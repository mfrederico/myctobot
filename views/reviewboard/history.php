<div class="container py-4" data-assist-page="reviewboard/history" data-assist-purpose="View historical review data and records">
    <!-- Header -->
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <?php if ($issueUrl !== '#'): ?>
                            <a href="<?= h($issueUrl) ?>" target="_blank" class="text-decoration-none">
                                <?= $issueNum ?>
                            </a>
                            <?php else: ?>
                            <span class="text-muted"><?= h($job->issue_key ?: '-') ?></span>
                            <?php endif; ?>
                        </td>
                        <td>
                            <?php if ($story): ?>
                        ...
                        <td>
                            <?php if ($prUrl): ?>
                            <a href="<?= h($prUrl) ?>" target="_blank" class="btn btn-sm btn-outline-success">
