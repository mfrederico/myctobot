        ...
        <div class="col-md-4">
            <?php if (!empty($workspaceError)): ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <p class="mb-3">
                            The workspace <strong>"<?= h($requestedWorkspace) ?>"</strong> doesn't exist yet.
                        </p>
                        <p class="text-muted mb-4">
                            Would you like to create a new workspace for your team?
                        </p>
                        <a href="<?= \app\services\SiteConfig::getBaseUrl() ?>/signup<?= !empty($requestedWorkspace) ? '?workspace=' . urlencode($requestedWorkspace) : '' ?>" class="btn btn-primary btn-lg mb-3">
                            <i class="bi bi-plus-circle"></i> Create New Workspace
                        </a>
                        <hr>
                        <p class="text-muted small mb-2">Already have a workspace?</p>
                        <a href="<?= \app\services\SiteConfig::getBaseUrl() ?>/login" class="btn btn-outline-secondary">
            ...
            <div class="card">
                <div class="card-header">
                    <h4>
                        <?php if ($hasWorkspace): ?>
                            Login to <span class="text-primary"><?= h($workspace) ?></span>
                        <?php else: ?>
                            Login to MyCTOBot
                        <?php endif; ?>
                    </h4>
                ...
                <div class="card-body">
                    ...
                    <?php if ($showGoogleOAuth): ?>
                        ...
                        <div class="d-grid gap-2 mb-4">
                            <a href="<?= h($googleUrl) ?>" class="btn btn-outline-danger btn-lg">
