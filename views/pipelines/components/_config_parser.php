    ...
    <div class="card bg-light mb-3">
        <div class="card-body">
            ...
            <div class="alert alert-secondary mt-3 mb-0 small">
                <strong><i class="bi bi-diagram-3 me-1"></i> Data Flow:</strong>
                <div class="mt-2">
                    <div class="d-flex align-items-center mb-1">
                        <span class="badge bg-primary me-2">STDIN</span>
                        <span>Full JSON output from previous step <i class="bi bi-arrow-right mx-1"></i> piped to jq</span>
                    </div>
                    <div class="d-flex align-items-center">
                        <span class="badge bg-success me-2">Exported Vars</span>
                        <span>Specific paths you chose <i class="bi bi-arrow-right mx-1"></i> available as <code>{step.var}</code> in later steps</span>
                    </div>
                </div>
                <hr class="my-2">
                <small class="text-muted">
                    <strong>Note:</strong> STDIN and Exported Variables are different!
                    jq processes the full STDIN. Exported variables are for <code>{variable}</code> substitution in other steps.
                </small>
            </div>
        </div>
    </div>
