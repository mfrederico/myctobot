...
#   ./scripts/monitor-job.sh SSI-1883 shard.example.com
#   ./scripts/monitor-job.sh SSI-1883 -v              # With Claude thinking
#   ./scripts/monitor-job.sh SSI-1883 shard.example.com -v
#
...
# Parse arguments
ISSUE_KEY=""
SHARD_IP="${SHARD_IP:-shard.example.com}"
VERBOSE=false
...
if [ -z "$ISSUE_KEY" ]; then
    ...
    echo "Examples:"
    echo "  $0 SSI-1883"
    echo "  $0 SSI-1883 shard.example.com"
    echo "  $0 SSI-1883 -v                # With Claude's thinking"
    echo "  $0 SSI-1883 shard.example.com -v"
    echo ""
