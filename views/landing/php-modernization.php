...
<head>
    ...
    <title><?= h($title ?? 'PHP Legacy Modernization - Don\'t Throw Away Your PHP | MyCTOBot') ?></title>
            ...
            <table class="comparison-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-success"><strong><?= h($smallProject) ?>-<?= h($enterpriseProject) ?></strong></td>
                    </tr>
                    <tr>
            ...
            <div class="pricing-grid">
                <div class="pricing-card">
                    <div class="pricing-header">
                        <h3>Starter</h3>
                        <div class="price"><?= h($smallProject) ?></div>
                ...
                <div class="pricing-card featured">
                    <div class="pricing-header">
                        <h3>Business</h3>
                        <div class="price"><?= h($mediumProject) ?></div>
                ...
                <div class="pricing-card">
                    <div class="pricing-header">
                        <h3>Enterprise</h3>
                        <div class="price"><?= h($enterpriseProject) ?>+</div>
