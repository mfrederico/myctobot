            ...
            <div class="card border-success">
                <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
                    <span>
                        ...
                        <span class="badge bg-info ms-2" title="Shared by <?= htmlspecialchars($key['owner_name'] ?: 'Unknown') ?>">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <p class="mb-2">
                                ...
                                <code><?= htmlspecialchars($key['masked_key']) ?></code>
                            </p>
                            <p class="mb-2">
                                <i class="bi bi-cpu me-1 text-muted"></i>
                                Model: <?= htmlspecialchars($key['model'] ?: 'claude-sonnet-4-20250514') ?>
                            </p>
                            <p class="mb-0 text-muted small">
                                Added <?= date('M j, Y', strtotime($key['created_at'])) ?>
                                by <?= htmlspecialchars($key['owner_name'] ?: 'Unknown') ?>
                            </p>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="text-muted small">
                                    <i class="bi bi-person"></i> Owned by <?= htmlspecialchars($key['owner_name'] ?: 'Unknown') ?>
                                </span>
                                <span></span>
                                <?php endif; ?>
                            </div>
