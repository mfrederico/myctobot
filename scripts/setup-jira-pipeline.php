...
// Get domain from config for example URL
$siteDomain = $config['site']['domain'] ?? 'myctobot.ai';
$siteProtocol = $config['site']['protocol'] ?? 'https';
$baseUrl = "{$siteProtocol}://{$siteDomain}";
...
echo "    {$baseUrl}/pipein/{$workspaceSlug}/{$pipeline->slug}\n\n";
