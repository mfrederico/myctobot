<div class="container py-4" data-assist-page="boards" data-assist-purpose="List and manage connected Jira boards">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <strong><?= h($board['board_name']) ?></strong>
                                    </td>
                                    <td><code><?= h($board['project_key']) ?></code></td>
                                    <td>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-sm btn-outline-danger"
                                                onclick="removeBoard(<?= $board['id'] ?>, '<?= h($board['board_name'], ENT_QUOTES) ?>')"
                                                title="Delete Board">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><code><?= h($board['project_key']) ?></code></td>
                                    <td>
                                        <small class="text-muted"><?= h($board['site_name'] ?? 'Unknown') ?></small>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <span class="badge bg-info">
                                            <i class="bi bi-clock"></i> <?= h($board['digest_time']) ?>
                                        </span>
                                        <br>
                                        <small class="text-muted"><?= h($board['timezone'] ?? 'UTC') ?></small>
                                        <?php else: ?>
                                        <span class="text-muted">Off</span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <small><?= h($board['status_filter'] ?? 'To Do') ?></small>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-danger"
                                                    onclick="removeBoard(<?= $board['id'] ?>, '<?= h($board['board_name']) ?>')"
                                                    title="Remove">
