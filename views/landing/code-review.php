...
<head>
    ...
    <title><?= h($title ?? 'AI Code Review - Automated PR Analysis | MyCTOBot') ?></title>
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-lg-4">
                    <div class="pricing-card featured">
                        ...
                        <h4>MyCTOBot Pro</h4>
                        <div class="price"><?= h($pricing['pro_monthly_formatted'] ?? '$1,999') ?><span class="price-period">/month</span></div>
