...
<footer class="footer mt-auto py-3">
    <div class="container">
        <div class="row">
            <!-- About Section -->
            <div class="col-md-4">
                <h5><?= h($site_name ?? 'MyCTOBot.ai') ?></h5>
                <p class="text-muted">
                    <?= h($site_description ?? 'Your AI-powered development team. Connect Jira and GitHub, label tickets, and watch the magic happen.') ?>
                </p>
            </div>
            ...
            <div class="col-md-4">
                ...
                <?php if ($contactPhone): ?>
                    <p class="mt-3 mb-1 text-muted">
                        <i class="bi bi-telephone"></i> <?= h($contactPhone) ?>
                    </p>
                <?php endif; ?>
                <?php if ($contactEmail): ?>
                    <p class="mb-0 text-muted">
                        <i class="bi bi-envelope"></i> <?= h($contactEmail) ?>
                    </p>
                <?php endif; ?>
            </div>
        </div>
...
<!-- AI Page Assistant (for logged-in users) -->
