<div class="container py-4" data-assist-page="studio/commerce" data-assist-purpose="Commerce studio for e-commerce workflows">
    <!-- Header -->
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h2 mb-1">
                <i class="bi <?= $studio['icon'] ?? 'bi-shop' ?> text-<?= $studio['color'] ?? 'success' ?>"></i>
                <?= h($studio['name'] ?? 'Commerce Studio') ?>
            </h1>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-4">
            <a href="/apps/templates" class="card border-0 shadow-sm text-decoration-none h-100">
                <div class="card-body d-flex align-items-center">
                    <div class="rounded bg-warning bg-opacity-10 p-3 me-3">
                        <i class="bi bi-box-arrow-up-right fs-4 text-warning"></i>
                    </div>
                    <div>
                        <div class="fw-semibold text-dark">Build an App</div>
                        <small class="text-muted">Widgets, tools &amp; more</small>
                    </div>
                </div>
            </a>
        </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="fw-semibold"><?= h($store['connection_name'] ?? $store['external_name'] ?? '') ?></span>
                                        </div>
                                    </td>
                                    <td>
                                        <small class="text-muted"><?= h($store['external_eid'] ?? '') ?></small>
                                    </td>
                                    <td>
                                        <?php
                                        $isActive = !empty($store['enabled']);
                                        $hasError = !empty($store['last_error']);
                                    ...
                                    <td class="text-end">
                                        <a href="/shopify" class="btn btn-sm btn-outline-primary" title="Manage Store">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                    </td>
                                </tr>
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="mb-3 d-flex align-items-start">
                            ...
                            <span class="small"><a href="/apps/templates" class="text-decoration-none">Build a customer support widget</a></span>
                        </li>
                        <li class="mb-3 d-flex align-items-start">
