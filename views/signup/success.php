    ...
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-8">
            ...
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    <div class="text-center mb-4">
                        ...
                        <a href="<?= h($workspace['url']) ?>" class="h4 text-decoration-none" target="_blank">
                            <?= h($workspace['url']) ?>
                        </a>
                    </div>
                    ...
                    <div class="d-grid">
                        <a href="<?= h($workspace['url']) ?>/auth/login" class="btn btn-primary btn-lg">
            ...
            <div class="card mt-4 border-info">
                <div class="card-body">
                    ...
                    <p class="card-text small text-muted mb-0">
                        Save <strong><?= h($workspace['url']) ?></strong> to your bookmarks.
            ...
            <div class="text-center mt-4 text-muted small">
                Need help? Contact <a href="mailto:<?= h($site_support_email ?? 'support@myctobot.ai') ?>"><?= h($site_support_email ?? 'support@myctobot.ai') ?></a>
            </div>
        </div>
    </div>
</div>
