...
The cron job `scripts/cron/cron-await-timeouts.php` handles stuck runs:
...
**Crontab entry:**
```
* * * * * cd /path/to/myctobot && php scripts/cron/cron-await-timeouts.php --script >> log/cron-timeouts.log 2>&1
```
