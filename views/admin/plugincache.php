                        ...
                        <div class="col-6">
                            ...
                            <p>
                                <?php if ($cache_stats['last_refresh']): ?>
                                    <?= h($cache_stats['last_refresh_formatted']) ?>
                                <?php else: ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-striped mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><code><?= h($error['source'] ?? 'Unknown') ?></code></td>
                                    <td class="text-danger"><?= h($error['error'] ?? 'Unknown error') ?></td>
                                    <td>
                                        <small class="text-muted"><?= h($error['timestamp'] ?? 'N/A') ?></small>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <strong><?= h($plugin['name'] ?? 'Unknown') ?></strong>
                                        <?php if (!empty($plugin['description'])): ?>
                                        <br><small class="text-muted"><?= h(substr($plugin['description'], 0, 100)) ?><?= strlen($plugin['description']) > 100 ? '...' : '' ?></small>
                                        <?php endif; ?>
                                    </td>
                                    <td><span class="badge bg-secondary"><?= h($plugin['version'] ?? '1.0.0') ?></span></td>
                                    <td><?= h($plugin['author'] ?? 'Unknown') ?></td>
                                    <td>
                                        <code class="small"><?= h(basename($plugin['source'] ?? 'unknown')) ?></code>
                                    </td>
                                    <td>
