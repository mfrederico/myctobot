<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h2 mb-1">
                ...
                <?= htmlspecialchars($studio['name'] ?? 'Developer Studio') ?>
            </h1>
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-3">
            <a href="/enterprise/create" class="card border-0 shadow-sm text-decoration-none h-100">
        ...
        <div class="col-lg-8">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="/enterprise" class="btn btn-sm btn-outline-primary">View All</a>
                </div>
                <div class="card-body p-0">
                    ...
                    <div class="text-center py-5">
                        ...
                        <a href="/enterprise/create" class="btn btn-primary mt-3">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <code class="fw-semibold"><?= htmlspecialchars($job['issue_key']) ?></code>
                                    </td>
                                    <td>
                                        <?php
                                        $statusColors = [
                                    ...
                                    <td>
                                        <small class="text-muted"><?= date('M j, g:ia', strtotime($job['created_at'])) ?></small>
                                    </td>
                                    <td class="text-end">
                                        <a href="/enterprise/job/<?= $job['id'] ?>" class="btn btn-sm btn-outline-primary">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                    </td>
                                </tr>
                ...
                <div class="card-body p-0">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            ...
                            <span class="small"><?= htmlspecialchars($repo['name'] ?? 'Unnamed') ?></span>
                        </li>
                        <?php endforeach; ?>
                    </ul>
                    <?php endif; ?>
            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <span class="badge bg-light text-dark me-2"><?= htmlspecialchars($board['project_key'] ?? '') ?></span>
                            <span class="small"><?= htmlspecialchars($board['name'] ?? 'Unnamed') ?></span>
                        </li>
                        <?php endforeach; ?>
                    </ul>
                    <?php endif; ?>
