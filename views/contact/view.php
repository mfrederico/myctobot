    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <strong>From:</strong> <?= h($message->name) ?>
                        &lt;<?= h($message->email) ?>&gt;
                    </div>
                ...
                <?php foreach ($responses as $response): ?>
                    ...
                    <div class="card mb-3">
                        <div class="card-header bg-success text-white">
                            ...
                            Response from <?= h($admin->username ?? 'Admin') ?>
                            <small class="float-end">
                                <?= date('M j, Y \a\t g:i A', strtotime($response->created_at)) ?>
                            </small>
                        </div>
                        <div class="card-body">
                            <?= nl2br(h($response->response)) ?>
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php endif; ?>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <small><?= h($message->ip_address ?: 'Not recorded') ?></small></p>

                    <p><strong>User Agent:</strong><br>
                    <small><?= h(substr($message->user_agent ?: 'Not recorded', 0, 100)) ?></small></p>
