<div class="container py-4">
    ...
    <div class="alert alert-success d-flex align-items-center mb-4">
        ...
        <div>
            <strong>Connected</strong> - Domain: <?= htmlspecialchars($settings['domain']) ?>
        </div>
        <div class="ms-auto">
                    ...
                    <form method="POST" action="/mailgun/save">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">
                                <?php if (!empty($settings['api_key_masked'])): ?>
                                    Current key: <?= htmlspecialchars($settings['api_key_masked']) ?>. Leave blank to keep existing key.
                                <?php else: ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                   ...
                                   id="domain"
                                   name="domain"
                                   value="<?= htmlspecialchars($settings['domain']) ?>"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                           ...
                                           id="from_name"
                                           name="from_name"
                                           value="<?= htmlspecialchars($settings['from_name'] ?: 'MyCTOBot') ?>"
...
function sendTestEmail() {
    const email = prompt('Send test email to:', '<?= htmlspecialchars($member->email ?? '') ?>');
    if (!email) return;
