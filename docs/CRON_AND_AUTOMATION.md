...
```bash
# Basic usage
php scripts/cron/cron-directive-processor.php --workspace=gwt

# With verbose output
php scripts/cron/cron-directive-processor.php --workspace=gwt --verbose

# Dry run (see what would be processed)
php scripts/cron/cron-directive-processor.php --workspace=gwt --dry-run
```
...
**Crontab:**
```bash
*/5 * * * * php /path/to/scripts/cron/cron-directive-processor.php --workspace=gwt >> /path/to/log/directive-processor.log 2>&1
```
...
# With verbose output
php scripts/cron/cron-analysis.php --script --secret=KEY --member=3 --board=1 --verbose

# Run and send email digest
php scripts/cron/cron-analysis.php --script --secret=KEY --member=3 --board=1 --email

# With job ID for progress tracking
php scripts/cron/cron-analysis.php --script --secret=KEY --member=3 --board=1 --job=abc123
```
...
php scripts/cron/cron-digest.php --script --workspace=gwt --verbose

# Dry run (see what would be sent)
php scripts/cron/cron-digest.php --script --dry-run

# Force send (ignore time windows)
php scripts/cron/cron-digest.php --script --force
```
...
**Crontab:**
```bash
0,15,30,45 * * * * php /path/to/scripts/cron/cron-digest.php --script >> /path/to/log/digest.log 2>&1
```
...
# ============================================
*/5 * * * * php /var/www/myctobot/scripts/cron/cron-directive-processor.php --workspace=gwt >> /var/www/myctobot/log/directive-processor.log 2>&1

# ============================================
# Daily Digest Scheduler (every 15 minutes)
# ============================================
0,15,30,45 * * * * php /var/www/myctobot/scripts/cron/cron-digest.php --script >> /var/www/myctobot/log/digest.log 2>&1
...
```bash
# Workspace: gwt
*/5 * * * * php /var/www/myctobot/scripts/cron/cron-directive-processor.php --workspace=gwt >> /var/www/myctobot/log/directive-gwt.log 2>&1

# Workspace: footest4
*/5 * * * * php /var/www/myctobot/scripts/cron/cron-directive-processor.php --workspace=footest4 >> /var/www/myctobot/log/directive-footest4.log 2>&1
```
