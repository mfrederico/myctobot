...
<div class="container py-4" data-assist-page="mcpservers" data-assist-purpose="Manage MCP servers and external tool integrations">
    <!-- Navigation Tabs -->
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted small mb-2"><?= h($server['description']) ?></p>
                    <?php endif; ?>

                    <?php if ($server['server_type'] === 'stdio'): ?>
                    <code class="small d-block text-truncate" title="<?= h($server['command'] . ' ' . implode(' ', $server['args'])) ?>">
                        <?= h($server['command']) ?> <?= h(implode(' ', $server['args'])) ?>
                    </code>
                    <?php else: ?>
                    <code class="small d-block text-truncate" title="<?= h($server['url']) ?>">
                        <?= h($server['url']) ?>
                    </code>
                    <?php endif; ?>
                    ...
                    <div class="mt-2">
                        <span class="badge bg-secondary">ENV: <?= h(implode(', ', array_keys($server['env']))) ?></span>
                    </div>
                    <?php endif; ?>
                ...
                <div class="card-footer bg-transparent">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group btn-group-sm">
                            <button type="button" class="btn btn-outline-success" onclick="testConnection(<?= $server['id'] ?>, '<?= h($server['name'], ENT_QUOTES) ?>')" title="Test Connection">
                        ...
                        <div class="btn-group btn-group-sm">
                            ...
                            <button type="button" class="btn btn-outline-danger" onclick="deleteServer(<?= $server['id'] ?>, '<?= h($server['name'], ENT_QUOTES) ?>')">
