<div class="container py-4" data-assist-page="boards/edit" data-assist-purpose="Edit board settings and configure analysis rules">
    <div class="row">
        <div class="col-md-10 offset-md-1">
            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <i class="bi bi-kanban"></i> <?= h($board['board_name']) ?>
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control form-control-sm" value="<?= h($board['site_name'] ?? 'Unknown') ?>" readonly disabled>
                        </div>
                    </div>
                                ...
                                <div class="row mb-3" id="digest_options">
                                    <div class="col-md-6">
                                        ...
                                        <input type="time" class="form-control" id="digest_time" name="digest_time"
                                               value="<?= h($board['digest_time'] ?? '08:00') ?>">
                                            ...
                                            <select class="form-select" name="aiagents_id" id="aiagents_id" <?= $isEnterprise ? '' : 'disabled' ?>>
                                                ...
                                                ?>
                                                    <option value="<?= $agent['id'] ?>" <?= ($board['aiagents_id'] ?? '') == $agent['id'] ? 'selected' : '' ?>>
                                                        <?= $providerIcon ?> <?= h($agent['name']) ?> (<?= h($agent['model']) ?>)
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                            <div class="form-text">
