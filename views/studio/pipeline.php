<div class="container py-4">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-3">
            <a href="/orchestration" class="card border-0 shadow-sm text-decoration-none h-100">
                <div class="card-body d-flex align-items-center">
                    <div class="rounded bg-primary bg-opacity-10 p-3 me-3">
                        <i class="bi bi-lightning-charge fs-4 text-primary"></i>
                    </div>
                    <div>
                        <div class="fw-semibold text-dark">Orchestration</div>
                        <small class="text-muted">AI-powered wizards</small>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="/mcpservers" class="card border-0 shadow-sm text-decoration-none h-100">
                <div class="card-body d-flex align-items-center">
                    <div class="rounded bg-warning bg-opacity-10 p-3 me-3">
                        <i class="bi bi-plug fs-4 text-warning"></i>
                    </div>
                    <div>
