...
<div class="container py-4" data-assist-page="knowledgebase/query" data-assist-purpose="Query knowledge base using semantic search">
            ...
            <div class="card border-0 shadow-sm mt-3">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <div class="fw-medium"><?= h($selectedAgent['name']) ?></div>
