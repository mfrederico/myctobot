...
class WorkspaceProvisioner {
    ...
    public function provision(
        ...
        try {
            ...
            return [
                ...
                'url' => SiteConfig::getWorkspaceUrl($subdomain)
            ];
    ...
    private function createConfigFile(
        ...
        // Get domain from SiteConfig for dynamic URL generation
...
client_id = ""
client_secret = ""
redirect_uri = "{$baseUrl}/atlassian/callback?workspace={$subdomain}"
scopes = ""
...
client_id = ""
client_secret = ""
redirect_uri = "{$baseUrl}/github/callback"
            ...
            if (preg_match('/^config\.([a-z0-9-]+)\.ini$/', $filename, $matches)) {
                ...
                if ($slug !== 'example' && $slug !== 'sqlite') {
                    $workspaces[] = [
                        'slug' => $slug,
                        'config' => $configPath,
                        'url' => SiteConfig::getWorkspaceUrl($slug)
                    ];
                }
            }
        }
