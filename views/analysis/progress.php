<div class="container py-4" data-assist-page="analysis/progress" data-assist-purpose="Monitor real-time progress of an ongoing analysis">
    <div class="row">
        <div class="col-md-8 offset-md-2">
            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <i class="bi bi-kanban"></i> <?= h($status['board_name']) ?>
                </div>
                <div class="card-body text-center py-5">
                    ...
                    <!-- Current Step -->
                    <h5 id="currentStep" class="mb-3"><?= h($status['current_step']) ?></h5>
