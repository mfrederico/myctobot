<div class="container py-4" data-assist-page="dashboard" data-assist-purpose="Main dashboard with connection status and quick actions">
    <div class="row">
        <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="mb-0">Dashboard</h1>
                <?php if (!empty($workspaceSlug) && $workspaceSlug !== 'default'): ?>
                <span class="badge bg-primary fs-6">
                    <i class="bi bi-building"></i> Workspace: <?= h($workspaceSlug) ?>
                </span>
                <?php endif; ?>
            </div>
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <br>
                                <small class="text-muted"><?= h($site->site_url) ?></small>
                            </div>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <strong><?= h($analysis['project_key'] ?? 'N/A') ?></strong>
                                    <br>
