...
// Log all errors, but never DISPLAY them by default — showing stack traces
// leaks paths, arguments and class internals (CWE-209). bootstrap.php re-enables
// display only for development environments.
