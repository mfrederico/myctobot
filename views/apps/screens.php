...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="/appbuilder/index/<?= $appId ?>" class="btn btn-info">
            ...
            <a href="/apps/pipelines/<?= $appId ?>" class="btn btn-primary">
        ...
        <div class="col-lg-7 mb-4">
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <a href="/apps/addblockscreen/<?= $appId ?>"
                            ...
                            <div class="card-body py-2 px-3">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <div class="d-flex gap-1">
                                        <a href="/appbuilder/index/<?= $appId ?>?screen_id=<?= (int) $screen->id ?>"
...
function saveScreenConfig() {
    ...
    fetch('/apps/updatescreens/' + appId, {
        method: 'POST',
        headers: {
