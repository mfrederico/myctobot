...
<head>
    ...
    <title><?= htmlspecialchars($title ?? 'AI Developer - Your Development Team That Never Sleeps | MyCTOBot') ?></title>
    <meta name="description" content="<?= htmlspecialchars($p['description'] ?? 'Label any Jira ticket with ai-dev and wake up to a pull request. AI that understands your codebase, follows your standards, and ships code while you sleep.') ?>">
