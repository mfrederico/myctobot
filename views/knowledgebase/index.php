    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2 align-items-center">
            ...
            <div class="input-group" style="width: auto;">
                ...
                <button class="btn btn-outline-danger" type="button" onclick="deleteKnowledgeBase(<?= $selectedKb->id ?>, '<?= htmlspecialchars($selectedKb->name) ?>')" title="Delete this KB">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <div class="mb-2">
                        ...
                        <?= htmlspecialchars($selectedKb->description) ?>
                    </div>
                    <?php endif; ?>
                    <div class="d-flex align-items-center gap-3 small">
                        <?php if ($selectedKb->slug): ?>
                        <span class="text-muted" title="API/MCP slug">
                            <i class="bi bi-link-45deg"></i> slug: <code><?= htmlspecialchars($selectedKb->slug) ?></code>
                        </span>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="text-end">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="/agents#agent-<?= $selectedAgent['id'] ?>" class="text-decoration-none">
                            <div class="d-flex align-items-center bg-light rounded px-3 py-2 agent-link-box">
                                <i class="bi bi-robot me-2"></i>
                                <div>
                                    <div class="fw-medium text-dark"><?= htmlspecialchars($selectedAgent['name']) ?></div>
                        ...
                        <tr data-doc-id="<?= $doc->id ?>" data-job-id="<?= htmlspecialchars($jobId) ?>" data-status="<?= $doc->status ?>">
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-2">
                                        <div class="fw-medium"><?= htmlspecialchars($doc->filename) ?></div>
                                        <?php if (!empty($doc->source_url)): ?>
                                        <small class="text-muted"><?= htmlspecialchars(parse_url($doc->source_url, PHP_URL_HOST)) ?></small>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="status-cell">
                                ...
                                <div class="small text-muted mt-1" style="font-size: 0.65rem;">
                                    <i class="bi bi-eye me-1"></i><?= htmlspecialchars($doc->vision_model) ?>
                                </div>
                                <?php endif; ?>
                                <?php else: ?>
                                <?php
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="kbAgentProfile" name="agent_profile_id">
                            ...
                            <option value="<?= $agent['id'] ?>">
                                ...
                                (<?= htmlspecialchars($agent['provider_label']) ?><?= $agent['model'] ? ' / ' . htmlspecialchars($agent['model']) : '' ?>)
                            </option>
                            <?php endforeach; ?>
                        </select>
                ...
                <form id="editKbForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="editKbName" name="name" required
                               value="<?= htmlspecialchars($selectedKb->name) ?>">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Description</label>
                        <textarea class="form-control" id="editKbDescription" name="description" rows="2"
                        ><?= htmlspecialchars($selectedKb->description ?? '') ?></textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Agent Profile (LLM)</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="<?= htmlspecialchars($selectedKb->slug) ?>" readonly disabled>
