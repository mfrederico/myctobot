...
class Mcpjira extends Control {
    ...
    private function authenticate(): bool {
        ...
        // Verify member has a connection for this cloud (or shared)
        $token = Bean::findOne('connections', 'connector_type = ? AND (member_id = ? OR shared = 1) AND external_eid = ?',
            ['atlassian', $this->memberId, $this->cloudId]);
