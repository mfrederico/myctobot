...
// NOTE: GitHub token is stored encrypted in the unified `connections` table with connector_type='github'
...
try {
    ...
    $aoePath = dirname(__DIR__, 2) . '/../aoe-php/vendor/autoload.php';
