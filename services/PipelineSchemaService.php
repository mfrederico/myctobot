    ...
    public static function getAllStepTypeSchemas(): array
    {
        return [
            ...
            'stitch_mcp' => [
                ...
                'category' => 'integration',
                'label' => 'Google Stitch',
                'description' => 'Call Google Stitch MCP tools for AI UI design generation. Generates screens, edits designs, creates variants.',
                'config_schema' => [
                    'connection_id' => [
                        'type' => 'integer',
                        'description' => 'Stitch connection ID from connections table. Supports {context.connection_id} variable. Auto-detects if empty.'
                    ],
                    'tool' => [
                        'type' => 'string',
                        'required' => true,
                        'description' => 'MCP tool name: create_project, list_projects, get_project, list_screens, get_screen, generate_screen_from_text, edit_screens, generate_variants'
                    ],
                    'arguments' => [
                        'type' => 'object',
                        'description' => 'Tool arguments as JSON object. Values support {context.key} and {step.output.key} variable substitution.'
                    ]
                ]
            ]
        ];
