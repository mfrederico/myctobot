<div class="container py-4" data-assist-page="jobs/view" data-assist-purpose="View job details, logs, and pull request links">
    <!-- Header with Back Button -->
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <a href="/activity?type=aidev" class="btn btn-outline-secondary btn-sm mb-2">
                <i class="bi bi-arrow-left"></i> Back to Jobs
            </a>
            <h1 class="h2 mb-0"><?= h($job['issue_key']) ?></h1>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-sm">
                        ...
                        <tr>
                            <th>Branch</th>
                            <td><code><?= h($job['branch_name']) ?></code></td>
                        </tr>
                        <?php endif; ?>
                        ...
                        <tr>
                            <th>Pull Request</th>
                            <td>
                                <a href="<?= h($job['pr_url']) ?>" target="_blank" class="btn btn-sm btn-outline-primary">
                    ...
                    <div class="mt-3">
                        ...
                        <button class="btn btn-warning btn-sm w-100" onclick="resumeJob('<?= h($job['issue_key']) ?>')">
                            <i class="bi bi-play-fill"></i> Resume Job
                        </button>
                        <?php endif; ?>

                        <?php if (in_array($job['status'], ['failed', 'pr_created', 'complete']) && !empty($job['branch_name'])): ?>
                        <button class="btn btn-primary btn-sm w-100 mb-2" onclick="retryJob('<?= h($job['issue_key']) ?>')">
                            <i class="bi bi-arrow-repeat"></i> Retry on Branch
                        </button>
                        <?php endif; ?>

                        <?php if ($job['status'] === 'pr_created'): ?>
                        <button class="btn btn-success btn-sm w-100" onclick="completeJob('<?= h($job['issue_key']) ?>')">
            ...
            <div class="card mt-3 border-danger">
                ...
                <div class="card-body">
                    <pre class="mb-0 text-danger" style="white-space: pre-wrap; word-break: break-word;"><?= h($job['error_message']) ?></pre>
                </div>
            </div>
            <?php endif; ?>
        ...
        <div class="col-lg-8">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body p-0">
                    <pre id="output-content" class="mb-0 p-3 bg-dark text-light" style="max-height: 400px; overflow-y: auto; font-size: 0.85rem; white-space: pre-wrap; word-break: break-word;"><?= h($job['last_output']) ?></pre>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body p-0">
                    <pre class="mb-0 p-3 bg-light" style="max-height: 300px; overflow-y: auto; font-size: 0.85rem;"><?= h(json_encode($job['last_result'], JSON_PRETTY_PRINT)) ?></pre>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="card mb-4">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item"><code><?= h($file) ?></code></li>
                    <?php endforeach; ?>
                </ul>
            </div>
            <?php endif; ?>
                ...
                <div class="card-body p-0" style="max-height: 400px; overflow-y: auto;">
                    <table class="table table-sm mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><small class="text-muted"><?= h($log['created_at']) ?></small></td>
                                <td>
