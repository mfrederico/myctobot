            ...
            <div class="card shadow">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="alert alert-info">
                        ...
                        You're joining <strong><?= h($workspaceDisplayName) ?></strong>
                    </div>
                    <?php endif; ?>

                    <div class="mb-4 text-center">
                        <p class="text-muted mb-1">Setting up account for:</p>
                        <strong class="fs-5"><?= h($email ?? '') ?></strong>
                    </div>

                    <form method="POST" action="/auth/invite/<?= h($token ?? '') ?><?= !empty($workspace) ? '?workspace=' . h($workspace) : '' ?>">
