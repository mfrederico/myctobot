<div class="container py-4" data-assist-page="directives/view" data-assist-purpose="View detailed directive content and actions">
    <div class="row">
        <div class="col-md-12">
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/directives">Directives</a></li>
                    <li class="breadcrumb-item active"><?= h(substr($directive->email_subject ?: 'Untitled', 0, 50)) ?></li>
                </ol>
            </nav>

            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1><?= h($directive->email_subject ?: '(No Subject)') ?></h1>
                <div>
                    <?php if (in_array($directive->status, ['failed', 'received'])): ?>
                    <button class="btn btn-warning retry-directive" data-id="<?= h($directive->directive_uid) ?>">
                        <i class="bi bi-arrow-clockwise"></i> Retry
                    </button>
                    <?php endif; ?>
                    <?php if ($directive->status !== 'completed'): ?>
                    <button class="btn btn-outline-danger cancel-directive" data-id="<?= h($directive->directive_uid) ?>">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <strong>From:</strong> <?= h($directive->email_from) ?>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="email-body bg-light p-3 rounded">
                                <pre class="mb-0" style="white-space: pre-wrap; font-family: inherit;"><?= h($directive->email_body) ?></pre>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item"><?= h(is_array($req) ? json_encode($req) : $req) ?></li>
                                <?php endforeach; ?>
                            </ul>
                            <?php else: ?>
                            <pre class="mb-0"><?= h($directive->parsed_requirements) ?></pre>
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php endif; ?>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <pre class="log-context d-none mt-2 p-2 bg-light rounded small"><?= h(json_encode(json_decode($log->context_json), JSON_PRETTY_PRINT)) ?></pre>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <span class="text-muted"><?= h($directive->current_phase) ?></span>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="mb-3">
                                ...
                                <p class="text-muted mb-0"><?= h($directive->parsed_summary) ?></p>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <h5><?= h($project->name) ?></h5>
                            <p class="text-muted small"><?= h($project->description ?: 'No description') ?></p>
                            <div class="mb-2">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <dl class="row mb-0">
                                ...
                                <dd class="col-7"><code class="small"><?= h(substr($directive->directive_uid, 0, 16)) ?>...</code></dd>

                                <dt class="col-5">Message ID</dt>
                                <dd class="col-7"><small class="text-muted"><?= h($directive->email_message_uid ?: '-') ?></small></dd>

                                <?php if ($member): ?>
                                <dt class="col-5">Member</dt>
                                <dd class="col-7"><?= h($member->email) ?></dd>
                                <?php endif; ?>
