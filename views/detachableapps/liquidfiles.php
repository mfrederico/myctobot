...
<div class="container-fluid py-4">
    ...
    <div class="mb-4">
        <nav aria-label="App setup steps">
            <ol class="breadcrumb bg-light p-3 rounded">
                ...
                <li class="breadcrumb-item">
                    <a href="/detachableapps/screens/<?= $appId ?>">
                ...
                <li class="breadcrumb-item">
                    <a href="/detachableapps/buildshopify/<?= $appId ?>">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="/detachableapps/pipelines/<?= $appId ?>" class="btn btn-outline-secondary">
                <i class="bi bi-arrow-left"></i> Back to Pipelines
            </a>
            <a href="/detachableapps/buildshopify/<?= $appId ?>" class="btn btn-primary">
...
function loadFile(fileId) {
    fetch('/detachableapps/getliquidfile/' + fileId)
        .then(r => r.json())
        .then(data => {
            if (!data.success) {
...
function saveFile() {
    ...
    fetch('/detachableapps/saveliquidfile', {
        method: 'POST',
...
function deleteFile() {
    ...
    fetch('/detachableapps/deleteliquidfile', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
document.getElementById('previewConnection').addEventListener('change', function() {
    ...
    fetch('/detachableapps/getshopifyproducts/' + connectionId)
        .then(r => r.json())
        .then(data => {
