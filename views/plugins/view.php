<div class="container py-4" data-assist-page="plugins/view" data-assist-purpose="View plugin details and documentation">
    <!-- Breadcrumb -->
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-start mb-4">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="lead text-muted mb-2">
                                <?= h($plugin['short_description'] ?: substr($plugin['description'], 0, 150)) ?>
                            </p>
                            ...
                            <div class="text-muted small">
                                ...
                                <a href="<?= h($plugin['author_url']) ?>" target="_blank" rel="noopener">
                                    <?= h($plugin['author']) ?>
                                </a>
                                <?php else: ?>
                                <?= h($plugin['author']) ?>
                    ...
                    <div class="row text-center border-top border-bottom py-3 mb-4">
                        ...
                        <div class="col">
                            <div class="h4 mb-0">v<?= h($plugin['version']) ?></div>
                        ...
                        <div class="col">
                            <div class="d-flex align-items-center p-2 border rounded hover-bg-light">
                                ...
                                <div class="flex-grow-1 min-width-0">
                                    <a href="/plugins/view/<?= h($related['slug']) ?>"
                                       class="text-decoration-none fw-bold d-block text-truncate">
                                        <?= h($related['name']) ?>
                                    </a>
                                    <small class="text-muted d-block text-truncate">
                                        <?= h($related['short_description'] ?: 'No description') ?>
                                    </small>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <a href="<?= h($plugin['documentation_url']) ?>"
                        ...
                        <a href="/plugins?category=<?= urlencode($plugin['category']) ?>"
                           class="btn btn-outline-secondary">
                            <i class="bi bi-folder"></i> Browse <?= h($plugin['category_name']) ?>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-0">
                    <table class="table table-sm table-borderless mb-0">
                        <tr>
                            ...
                            <td class="pe-3"><?= h($plugin['version']) ?></td>
                        </tr>
                        <tr>
                            <td class="text-muted ps-3">Category</td>
                            <td class="pe-3"><?= h($plugin['category_name']) ?></td>
                        </tr>
                        <?php if ($plugin['author']): ?>
                        <tr>
