...
<div class="container py-4" style="max-width: 960px;">
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-2">
                    ...
                    <li class="breadcrumb-item"><a href="/detachableapps/form/<?= $appId ?>"><?= $appName ?></a></li>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="/detachableapps/release/<?= $appId ?>" id="releaseForm">
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <a href="/detachableapps/download/<?= $appId ?>?release=<?= $releaseId ?>"
