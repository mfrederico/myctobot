        ...
        <div class="col-12">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/detachableapps/form/<?= $app->id ?>"><?= h($app->name) ?></a></li>
                    <li class="breadcrumb-item"><a href="/detachableapps/liquidfiles/<?= $app->id ?>">Shopify Theme Files</a></li>
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <?php if ($bundle_exists): ?>
                        <a href="/detachableapps/downloadshopify/<?= $app->id ?>" class="btn btn-outline-primary">
                        ...
                        <div class="card-body">
                            ...
                            <?php if ($total_files === 0): ?>
                                <div class="alert alert-warning mt-3 mb-0">
                                    ...
                                    <a href="/detachableapps/liquidfiles/<?= $app->id ?>" class="alert-link">Shopify Theme Files</a> section first.
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <?php if ($bundle_exists): ?>
                                    <a href="/detachableapps/downloadshopify/<?= $app->id ?>" class="btn btn-outline-success btn-lg">
                                        <i class="bi bi-download"></i> Download ZIP
                                    </a>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a href="/detachableapps/form/<?= $app->id ?>" class="btn btn-sm btn-outline-secondary w-100">
...
document.getElementById('buildBtn').addEventListener('click', async function() {
    ...
    try {
        const response = await fetch('/detachableapps/dobuildshopify/' + APP_ID, {
            method: 'POST',
            headers: {
...
if (deployBtn) {
    deployBtn.addEventListener('click', async function() {
        ...
        try {
            ...
            const url = '/detachableapps/deployshopify/' + APP_ID + (connectionId ? '?connection_id=' + connectionId : '');
