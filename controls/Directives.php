...
class Directives extends BaseControls\Control {
    ...
    public function retry($params = []) {
        ...
        Flight::jsonSuccess(['ceodirectives_id' => $directive->ceodirectives_id], 'Directive queued for retry');
    }
    ...
    public function cancel($params = []) {
        ...
        Flight::jsonSuccess(['ceodirectives_id' => $directive->ceodirectives_id], 'Directive cancelled');
    }
    ...
    public function delete($params = []) {
        ...
        if ($project) {
            ...
            foreach ($project->ownCtoepicsList as $epic) {
                foreach ($epic->ownCtostoriesList as $story) {
                    Bean::trash($story);
                }
                Bean::trash($epic);
            }
    ...
    public function receive() {
        ...
        $this->logger->info('Directive received and queued', [
            'ceodirectives_id' => $result['ceodirectives_id'],
