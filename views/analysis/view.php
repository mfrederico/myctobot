<div class="container py-4" data-assist-page="analysis/view" data-assist-purpose="View detailed sprint analysis results">
    <div class="row">
        <div class="col-md-10 offset-md-1">
            ...
            <div class="alert alert-light border mb-4">
                <div class="row">
                    <div class="col-md-4">
                        <strong>Board:</strong> <?= h($board['board_name']) ?>
                    </div>
                    <div class="col-md-4">
                        <strong>Project:</strong> <code><?= h($board['project_key']) ?></code>
                    </div>
                    <div class="col-md-4">
                        <strong>Type:</strong>
                        <span class="badge <?= $analysis['analysis_type'] === 'digest' ? 'bg-info' : 'bg-primary' ?>">
                            <?= h($analysis['analysis_type']) ?>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-4 border-info">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <ul class="list-unstyled mb-0">
                                ...
                                <li>
                                    <span class="badge bg-primary me-2"><?= h($value) ?></span>
                                    <?= h(ucwords(str_replace('_', ' ', $weight))) ?>
                                </li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <ul class="list-unstyled mb-0">
                                ...
                                <li>
                                    <span class="badge bg-success me-2"><?= h($value) ?></span>
                    ...
                    <div class="collapse mt-3" id="configDetails">
                        ...
                        <pre class="bg-dark text-light p-3 rounded" style="max-height: 400px; overflow-y: auto; font-size: 0.85rem; white-space: pre-wrap;"><?= h($data['config_context']['system_prompt_used'] ?? 'Not available') ?></pre>
                    </div>
                </div>
            </div>
            <?php endif; ?>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex mb-3 pb-3 <?= $index < count($data['priorities']) - 1 ? 'border-bottom' : '' ?>">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <strong><?= h($priority['key'] ?? 'Unknown') ?></strong>:
                            <?= h($priority['summary'] ?? '') ?>
                            <br>
                            <small class="text-muted"><?= h($priority['reasoning'] ?? '') ?></small>
                        </div>
                    </div>
                    <?php endforeach; ?>
                </div>
                ...
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <strong><?= h($blocked['key'] ?? 'Unknown') ?></strong>:
                            <?= h($blocked['summary'] ?? '') ?>
                            <br>
                            <small class="text-danger"><?= h($blocked['reason'] ?? '') ?></small>
                        </li>
                        <?php endforeach; ?>
                    </ul>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="card mb-3 <?= $item['clarity_score'] < 4 ? 'border-danger' : ($item['clarity_score'] < 6 ? 'border-warning' : 'border-secondary') ?>">
                        <div class="card-header d-flex justify-content-between align-items-center py-2">
                            <div>
                                <strong><?= h($item['key']) ?></strong>
                                <span class="text-muted">- <?= h($item['summary'] ?? '') ?></span>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <div>
                                        ...
                                        <?= h($item['reporter_name'] ?? 'Unknown') ?>
                                        <?php if (!empty($item['reporter_email'])): ?>
                                        <br><small class="text-muted">
                                            <i class="bi bi-envelope"></i>
                                            <a href="mailto:<?= h($item['reporter_email']) ?>">
                                                <?= h($item['reporter_email']) ?>
                                            </a>
                                        </small>
                                        <?php endif; ?>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div><?= h($item['type'] ?? 'Task') ?></div>
                                </div>
                                <div class="col-md-3">
                                    <small class="text-muted">Priority:</small>
                                    <div><?= h($item['priority'] ?? 'Medium') ?></div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <p class="mb-0"><?= h($item['assessment']) ?></p>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="mb-3">
                                ...
                                <ul class="mb-0 ps-3">
                                    ...
                                    <li><span class="text-danger"><?= h($element) ?></span></li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="mb-0">
                                ...
                                <ul class="mb-0 ps-3">
                                    ...
                                    <li class="text-primary"><?= h($question) ?></li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
                            <?php endif; ?>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <pre id="rawMarkdown" style="display: none; white-space: pre-wrap;"><?= h($markdown ?? '') ?></pre>
                </div>
            </div>
        </div>
    </div>
