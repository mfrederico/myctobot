<div class="container py-4" data-assist-page="analysis" data-assist-purpose="Run sprint analysis on Jira boards and view analysis history">
    <div class="row">
        <div class="col-md-12">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <strong><?= h($analysis['board_name'] ?? 'Unknown') ?></strong>
                                                <br>
                                                <code class="small"><?= h($analysis['project_key'] ?? 'N/A') ?></code>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <small class="text-muted"><?= h($analysis['status_filter'] ?? 'All') ?></small>
                                            </td>
                                            <td>
