        ...
        <div class="row justify-content-center">
            <div class="col-lg-10 text-center">
                ...
                <p class="lead mb-5 text-light opacity-75 mx-auto" style="max-width: 700px;">
                    MyCTOBot is an AI engineering team that takes your requirements and ships production-ready code — opinionated towards PHP, performance, and low overhead.
                </p>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="text-center">
                    ...
                    <h5>Implement</h5>
                    <p class="text-muted">
                        Code gets written, reviewed, and tested. Clean, performant, no bloat.
                    </p>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
...
<div class="py-5 bg-light">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h2 class="mb-4">Opinionated AI. On purpose.</h2>
                <p class="lead text-muted mb-4">
                    Most AI coding tools generate bloated, over-engineered code. MyCTOBot doesn't.
                </p>
                <p class="text-muted mb-4">
                    We're opinionated towards PHP, high-performance patterns, and minimal dependencies. No framework bloat. No unnecessary abstractions. Just clean, fast code that ships.
                </p>
                <p class="fw-semibold">Built for agencies and teams who value speed and simplicity.</p>
                <a href="/landing/whyphp" class="btn btn-outline-primary mt-3">Why PHP? →</a>
            </div>
            <div class="col-lg-6">
                <div class="card border-0 shadow-lg">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div>
                                <h5 class="mb-0">AI with good defaults</h5>
                                <small class="text-muted">No arguing about best practices</small>
                            </div>
                        </div>
                        <ul class="list-unstyled mb-0">
                            <li class="mb-3 d-flex align-items-center">
                                <i class="bi bi-check-circle text-success me-3"></i>
                                <span>PHP-first, performance-focused</span>
                            </li>
                            <li class="mb-3 d-flex align-items-center">
                                <i class="bi bi-check-circle text-success me-3"></i>
                                <span>Minimal dependencies, maximum speed</span>
                            </li>
                            <li class="mb-3 d-flex align-items-center">
                                <i class="bi bi-check-circle text-success me-3"></i>
                                <span>Security baked in, not bolted on</span>
                            </li>
                            <li class="d-flex align-items-center">
                                <i class="bi bi-check-circle text-success me-3"></i>
                                <span>Customizable via CLAUDE.md when needed</span>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="input-group mb-3">
                    ...
                    <span class="input-group-text">.<?= h($site_domain ?? 'myctobot.ai') ?></span>
                </div>
                <div class="d-grid">
