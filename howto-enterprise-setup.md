...
4. Fill in the form:
   ...
   | Authorization callback URL | `https://myctobot.ai/connections/callback/github` |
...
redirect_uri = "https://myctobot.ai/connections/callback/github"
```
...
6. In MyCTOBot: Go to **/anthropic/keys**
7. Paste the API key and save

### Step 2: Connect GitHub

1. In MyCTOBot: Go to **/connections**
...
| `controls/Enterprise.php` | Enterprise redirect stub (delegates to Jobs, Github, Anthropic, etc.) |
