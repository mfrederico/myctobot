        ...
        <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <h1 class="mt-2"><i class="bi bi-diagram-3"></i> <?= htmlspecialchars($project->name) ?></h1>
                    <?php if ($directive): ?>
                    <p class="text-muted mb-0">
                        <small>
                            <i class="bi bi-envelope"></i> From: <?= htmlspecialchars($directive->email_subject) ?>
            ...
            <div class="card mb-4" id="epic-<?= $epic->id ?>">
                ...
                <div class="card-body border-bottom bg-white">
                    <small class="text-muted"><?= nl2br(htmlspecialchars($epic->description)) ?></small>
                </div>
                <?php endif; ?>
                        ...
                        <tbody>
                            ...
                            <tr id="story-row-<?= $story->story_id ?>">
                                <td>
                                    ...
                                    <br><small class="text-muted"><?= htmlspecialchars(substr($story->description, 0, 100)) ?><?= strlen($story->description) > 100 ? '...' : '' ?></small>
                                    <?php endif; ?>
                                    <?php
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="edit-project-name" value="<?= htmlspecialchars($project->name) ?>">
                </div>
                <div class="mb-3">
                    <label class="form-label">Description</label>
                    <textarea class="form-control" id="edit-project-description" rows="4"><?= htmlspecialchars($project->description ?? '') ?></textarea>
                </div>
            </div>
