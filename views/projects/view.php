                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="epic-<?= $epic->id ?>" class="accordion-collapse collapse <?= $index === 0 ? 'show' : '' ?>">
                                        <div class="accordion-body">
                                            <p class="text-muted"><?= htmlspecialchars($epic->description) ?></p>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-sm mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <span title="<?= htmlspecialchars($story->title) ?>">
                                                                    <?= htmlspecialchars(substr($story->title, 0, 60)) ?>...
                                                                </span>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="#" class="text-decoration-none" title="View in Jira">
                                                                    <code><?= htmlspecialchars($story->jira_issue_key) ?></code>
                                                                </a>
                                                                <?php else: ?>
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div>
                                            <strong><?= htmlspecialchars($risk['risk'] ?? $risk) ?></strong>
                                            <?php if (!empty($risk['mitigation'])): ?>
                                            <br><small class="text-muted">Mitigation: <?= htmlspecialchars($risk['mitigation']) ?></small>
                                            <?php endif; ?>
                                        </div>
