            ...
            <div class="card shadow-lg">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-end">
                        ...
                        <span class="countdown badge bg-dark text-light" data-timeout="<?= htmlspecialchars($timeout_at) ?>">
                        ...
                        <div class="accordion-item bg-transparent border-secondary">
                            ...
                            <div id="contextCollapse" class="accordion-collapse collapse" data-bs-parent="#contextAccordion">
                                <div class="accordion-body font-monospace small">
                                    ...
                                    <div class="mb-1">
                                        <span class="context-key"><?= htmlspecialchars($key) ?>:</span>
                                        <span class="context-value">
                                            <?php if (is_array($value) || is_object($value)): ?>
                                                <pre class="mb-0 text-muted small"><?= htmlspecialchars(json_encode($value, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES)) ?></pre>
                                            <?php else: ?>
                ...
                <div class="card-footer text-muted small d-flex justify-content-between">
                    <span>
                        <i class="bi bi-tag"></i>
                        Run: <code class="text-white"><?= htmlspecialchars(substr($run_uid, 0, 16)) ?>...</code>
                    </span>
                    <span>
